...
Agentic OS v5.0.0 — a Claude Code plugin providing a persistent agent memory system. It installs skills, hooks, agents, and commands that persist project knowledge across sessions in `.agent-memory/`.
