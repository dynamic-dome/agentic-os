...
| pattern-extractor | errors.json, iteration-log.md, patterns.json | patterns.json, patterns.md, generated-skills/<name>/SKILL.md (Step 6.5 skill-candidate generation, former skill-generator) | — |
